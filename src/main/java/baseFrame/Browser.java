...
public class Browser {
    ...
    private void setFirefox() {
        //  设置狐火浏览的路径
        System.setProperty("webdriver.firefox.bin", SeleniumConfig.fireFoxPath);
        // 设置火狐浏览器的驱动位置
        //System.setProperty("webdriver.firefox.marionette", "");
        System.setProperty("webdriver.gecko.driver", SeleniumConfig.fireFoxDriver);
        driver = new FirefoxDriver();
        logger.info("启动狐火浏览器成功！");
    }
    ...
    private void setChrome() {
        //设置谷歌驱动的位置
        System.setProperty("webdriver.chrome.driver", SeleniumConfig.chormeDriver);
